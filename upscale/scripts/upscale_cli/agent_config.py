...
Copied from ``shared/agent-config`` so the skill remains independently installable.
"""
...
def config_candidates(
    ...
    *,
    ...
    resolved_global_config = _absolute(
        global_config or DEFAULT_GLOBAL_CONFIG, base=working_dir
    )
    ...
    *,
    ...
    if path is not None:
        ...
        candidates = config_candidates(
            skill_dir, cwd=working_dir, global_config=global_config, filename=filename
        )
